...
if __name__ == "__main__":
    ...
    # path = '/standard/storage/CognitiveEMS_Datasets/anonymous/Sep_2024/Raw/05-09-2024/'


    # path = '/standard/storage/CognitiveEMS_Datasets/anonymous/Sep_2024/Raw/20-09-2024/anonymous/cardiac_scenario'

...
learning_params = {
    ...
    "patience": 3,
    "lr_drop": 20,
    "best_chkpoint": "/scratch/cjh9fw/Rivanna/2024/repos/EgoExoEMS/Benchmarks/ActionRecognition/MTRSAP/checkpoints/2557975/val_best_model.pt"
}
...
dataloader_params = {
    ...
    'modality': [ 'resnet_exo', 'resnet','smartwatch'],
    'keysteps' : {

...
#SBATCH --error="/scratch/cjh9fw/Rivanna/2024/repos/EgoExoEMS/Benchmarks/CPR_quality/vision/logs/job-%j-egoexoems_ego_cpr_rate.err"
#SBATCH --output="/scratch/cjh9fw/Rivanna/2024/repos/EgoExoEMS/Benchmarks/CPR_quality/vision/logs/job-%j-egoexoems_ego_cpr_rate.output"
